...
main_application.title('Learning Pad text editor')
...
main_menu = tk.Menu()
# file icons
new_icon = tk.PhotoImage(file='icons2/file.png')
open_icon = tk.PhotoImage(file='icons2/folder.png')
save_icon = tk.PhotoImage(file='icons2/diskette.png')
save_as_icon = tk.PhotoImage(file='icons2/save-file.png')
exit_icon = tk.PhotoImage(file='icons2/outbox.png')

file = tk.Menu(main_menu, tearoff=False)

##### Edit
# Edit Icons
copy_icon = tk.PhotoImage(file='icons2/files.png')
past_icon = tk.PhotoImage(file='icons2/paste.png')
cut_icon = tk.PhotoImage(file='icons2/scissors.png')
clear_all_icon = tk.PhotoImage(file='icons2/cleaning.png')
...
##### View
# View Icons
tool_bar_icon = tk.PhotoImage(file='icons2/seo.png')
status_bar_icon = tk.PhotoImage(file='icons2/statistics.png')
...
font_size['values'] = tuple(range(8,100))
font_size.current(4)
font_size.grid(row=0,column=1,padx=5)

## bold button
bold_icon = tk.PhotoImage(file='icons2/bold-text-option.png')
bold_btn =ttk.Button(tool_bar,image=bold_icon)
bold_btn.grid(row=0,column=2,padx=1)

## italic_button
italic_icon = tk.PhotoImage(file='icons2/italics.png')
...
## font color button
font_color_icon = tk.PhotoImage(file='icons2/color-circle.png')
font_color_btn =ttk.Button(tool_bar,image=font_color_icon)
font_color_btn.grid(row=0,column=5,padx=1)

## align left
align_left_icon = tk.PhotoImage(file='icons2/align.png')
align_left_btn =ttk.Button(tool_bar,image= align_left_icon)
align_left_btn.grid(row=0,column=6,padx=1)

## align center
align_center_icon  = tk.PhotoImage(file='icons2/centered-text-of-alignment-button.png')
align_center_btn =ttk.Button(tool_bar,image=align_center_icon )
align_center_btn.grid(row=0,column=7,padx=1)

## align Right
align_right_icon  = tk.PhotoImage(file='icons2/align-right.png')
...
file.add_command(label='Open folder',image=open_icon, compound=tk.LEFT,accelerator='Ctrl+O', command=open_file)
...
edit.add_command(label='Find',image=find_icon, compound=tk.LEFT,accelerator='Ctrl+F',command= find_data)

## view check box commands
...
main_application.bind("<Control-f>", find_data)
